...
public class MessageDispatcher
{
    ...
    public MessageDispatcher(IServiceScopeFactory scopeFactory)
    {
        ...
        .ToDictionary<TypeInfo, string, Func<IServiceProvider, IMessageHandler>>(
            info =>
            {
                using var scope = _scopeFactory.CreateScope(); // Criar um escopo para a DI
                var instance = (IMessageHandler)scope.ServiceProvider.GetRequiredService(info.AsType());
                return instance.MessageType.Name;
            },
